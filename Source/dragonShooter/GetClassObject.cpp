...
UObject* UGetClassObject::GetClassObject(UClass* inClass)
{
	if (inClass)
	{
		UObject* ret = inClass->GetDefaultObject();
...
UActorComponent* UGetClassObject::FindDefaultComponentByClass(const TSubclassOf<AActor> InActorClass,
